...
/** REDUX SELECTOR */
const randomRestaurantsRetriever = createSelector(retrieveRandomRestaurants, (randomRestaurants) => ({
	randomRestaurants,
}));
const chosenRestaurantsRetriever = createSelector(retrieveChosenRestaurants, (chosenRestaurant) => ({
	chosenRestaurant,
}));
const targetProductsRetriever = createSelector(retrieveTargetProducts, (targetProducts) => ({
	targetProducts,
}));
						...
						{Array.from(Array(4).keys()).map((ele, index) => {
							return (
								<Box className={'review_box'} key={index}>
									...
									<p className={'review_desc'}>Menga bu oshxonaning taomi juda yoqadi. Hammaga tafsiya qilaman!!!</p>
