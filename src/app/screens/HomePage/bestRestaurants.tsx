...
/** REDUX SELECTOR */
const bestRestaurantsRetriever = createSelector(retrieveBestRestaurants, (bestRestaurants) => ({
	bestRestaurants,
}));
...
export function BestRestaurants() {
	...
	return (
		<div className="best_restaurant_frame">
			<img src={'icons/line_group.svg'} style={{ position: 'absolute', left: '6%', transform: 'rotate(90deg)' }} />
