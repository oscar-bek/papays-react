...
import { retrieveChosenMember, retrieveChosenMemberBoArticle, retrieveChosenSingleBoArticle } from './selector';
...
export function VisitMyPage(props: any) {
	...
	useEffect(() => {
		...
		memberService
			...
			.catch((err) => console.log(err));
	}, [articlesRebuild, memberArticleSearchObj, followRebuild, verifiedMemberData]);

	/** HANDLERS **/
	const handleChange = (even: any, newValue: string) => {
		setValue(newValue);
	};
